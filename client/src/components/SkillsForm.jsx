  ...
  return (
    <div className='space-y-4'>
      <div>
        ...
        <p className='text-sm text-gray-500'>Add your technical and soft sills</p>
      </div>

      <div className='flex gap-2'>
        <input type="text" placeholder='Enter a skill (e.g., JavaScript, Project Mangement' className='flex-1 py-2 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
